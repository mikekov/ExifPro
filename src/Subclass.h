...
//
// * Instantiate your derived class somewhere and call HookWindow(wnd)
...
public:
	...
	BOOL	HookWindow(CWnd* wnd)	{ return HookWindow(wnd->GetSafeHwnd()); }
...
protected:
	...
	WNDPROC			old_wnd_proc_;		// ..and original window proc
	CSubclassWnd*	next_;				// next in chain of hooks for this window
