...
// Sigma raw (Foveon format)


class PhotoInfoX3F : public PhotoInfo_XMP
{
public:
	PhotoInfoX3F();
	virtual ~PhotoInfoX3F();
...
private:
	PhotoInfoX3F& operator = (const PhotoInfoX3F&);
	PhotoInfoX3F(const PhotoInfoX3F&);
