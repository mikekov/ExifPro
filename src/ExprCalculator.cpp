...
#define CASE(id, fld, v)	\
	...
	CASE('seco',	"second",	photo->GetDateTime().time_of_day().seconds())
	CASE('minu',	"minute",	photo->GetDateTime().time_of_day().minutes())
	CASE('hour',	0,			photo->GetDateTime().time_of_day().hours())
